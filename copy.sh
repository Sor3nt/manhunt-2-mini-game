...
cp src/all_anim.ifp $game/levels/A01_Escape_Asylum/allanims_pc.ifp
cp src/stranim_.bin $game/levels/A01_Escape_Asylum/strmanim_pc.bin
cp src/modelspc.mdl $game/levels/A01_Escape_Asylum
cp src/resource3.glg $game/levels/A01_Escape_Asylum
